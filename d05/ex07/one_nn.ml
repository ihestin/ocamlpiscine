...
(*                                                +#+#+#+#+#+   +#+           *)
(*   Created: 2018/06/05 14:21:43 by ihestin           #+#    #+#             *)
(*   Updated: 2018/06/05 14:21:51 by ihestin          ###   ########.fr       *)
(*                                                                            *)
(* ************************************************************************** *)
...
let one_nn (radarl : radar list) (rad1 : radar) =
	k_nn radarl  1 rad1
...
let rec test = function
	| a::b ->  (print_endline (one_nn radarl a); test b)
	| []-> ()
